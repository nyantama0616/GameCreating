...
let io=require("socket.io-client");class Manager{static socket=io("localhost:5000")}let p5=require("p5"),sketch=e=>{let t,a;e.preload=()=>{Background.loadBGMS(),Pattern.setDesign()},e.setup=()=>{let e=createCanvas(1280,800);Background.set(),e.parent("screen"),e.position(displayWidth/2-640,displayHeight/2-450),t=new Player(220,50),a=new Opponent(750,50)},e.draw=()=>{background(50),Background.loopBGM(),t.draw(),a.draw()}},multi=new p5(sketch);class Opponent{constructor(e,t){this.x=e,this.y=t,this.field=new Array(Game.H);for(let a=0;a<Game.H;a++){this.field[a]=new Array;for(let t=0;t<Game.W;t++){let e=new Block(this.x+t*Block.L+2*t,this.y+a*Block.L+2*a,Pattern.NUM);a!=Game.H-1&&0!=t&&t!=Game.W-1||(e.setLit(!0),e.setIsLocked(!0)),this.field[a].push(e)}}}draw(){for(let t=0;t<Game.H;t++)for(let e=0;e<Game.W;e++)this.field[t][e].draw()}}
},{"p5":29,"socket.io-client":32}],6:[function(require,module,exports){
...
},{"./transports/index":13,"./util":19,"component-emitter":8,"debug":21,"engine.io-parser":27,"parseqs":30,"parseuri":31}],12:[function(require,module,exports){
const parser = require("engine.io-parser");
const Emitter = require("component-emitter");
const { installTimerFunctions } = require("./util");
...
},{"./util":19,"component-emitter":8,"debug":21,"engine.io-parser":27}],13:[function(require,module,exports){
...
},{"../transport":12,"debug":21,"engine.io-parser":27,"parseqs":30,"yeast":47}],17:[function(require,module,exports){
const globalThis = require("../globalThis");
const nextTick = (() => {
...
},{"../transport":12,"../util":19,"./websocket-constructor":17,"buffer":2,"debug":21,"engine.io-parser":27,"parseqs":30,"yeast":47}],19:[function(require,module,exports){
const globalThis = require("./globalThis");
...
},{"./globalThis":9}],20:[function(require,module,exports){
...
},{"./manager":33,"./socket":35,"./url":37,"debug":38,"socket.io-parser":42}],33:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./on":34,"./socket":35,"./typed-events":36,"backo2":6,"debug":38,"engine.io-client":10,"engine.io-client/lib/util":19,"socket.io-parser":42}],34:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.on = void 0;
...
},{"./on":34,"./typed-events":36,"debug":38,"socket.io-parser":42}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./common":39,"_process":4,"dup":21}],39:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"dup":22,"ms":40}],40:[function(require,module,exports){
...
},{"./binary":41,"./is-binary":43,"component-emitter":8,"debug":44}],43:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
arguments[4][21][0].apply(exports,arguments)
},{"./common":45,"_process":4,"dup":21}],45:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"dup":22,"ms":46}],46:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
